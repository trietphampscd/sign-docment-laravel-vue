            ...
            <fieldset>
                ...
                <form id="form-record" action="/admin/users/new" method="post" enctype="multipart/form-data" class="form-horizontal">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="controls controlsDisplay col-md-7">
                            <div>
                                <input value="{{old('user.password')}}" data-validation="length"  data-validation-length="5-50" type="password" id="user_password" name="password" placeholder="" class="form-control">
                            </div>
                        </div>
                    </div>  
